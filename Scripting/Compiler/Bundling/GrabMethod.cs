...
namespace IronAHK.Scripting
{
	partial class ILMirror
	{
		...
		private MethodInfo MethodReplaceGenerics(MethodInfo Original)
		{
		...
		private MethodInfo FindBaseMethod(MethodInfo Original, Type Source)
		{
		...
		private MethodBase FindMatchingGenericMethod(MethodBase Orig)
		{
		...
		private static bool GenericMethodIsEquivalent(MethodBase Orig, MethodBase GenericCousin, ParameterInfo[] OrigParams)
		{
