...
namespace IronAHK.Scripting
{
	partial class MethodWriter
	{
		...
		private void EmitStatementCollection(CodeStatementCollection Statements)
		{
			if (Depth != 0) Depth++;
		...
		private void EmitStatement(CodeStatement Statement, bool ForceTypes)
		{
		...
		private Type EmitPrimitive(CodePrimitiveExpression Primitive)
		{
			Type T;
		...
		private Type EmitLiteral(Type T, object Value)
		{
			Depth++;
			Type Generated = T;
