...
namespace IronAHK.Scripting
{
	...
	{
		private Type EmitExpressionStatement(CodeExpressionStatement Expression, bool ForceTypes)
		{
			Depth++;
		...
		private Type EmitExpression(CodeExpression Expression)
		{
		...
		private Type EmitPropertyReferenceExpression(CodePropertyReferenceExpression prop)
		{
		...
		private Type EmitBinaryOperator(CodeBinaryOperatorExpression Binary, bool ForceTypes)
		{
		...
		private Type EmitCodeFieldReference(CodeFieldReferenceExpression field)
		{
			Depth++;
