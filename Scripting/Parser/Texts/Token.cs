...
namespace IronAHK.Scripting
{
	partial class Parser
	{
		...
		private enum Token
		{
			Unknown, Assign, Command, Label, Hotkey, Flow, Expression, Directive
		}
		...
		private bool IsHotstringLabel(string code)
		{
		...
		private bool IsAssignment(string code)
		{
			int i = 0;
		...
		private bool IsDirective(string code)
		{
