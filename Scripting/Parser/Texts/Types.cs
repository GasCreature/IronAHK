...
namespace IronAHK.Scripting
{
	partial class Parser
	{
		...
		private bool IsVariable(string code)
		{
		...
		private bool IsPrimativeObject(string code, out object result)
		{
			result = null;
		...
		private bool IsPrimativeObject(string code)
		{
			object result;
			return IsPrimativeObject(code, out result);
		}

		#endregion Primatives
