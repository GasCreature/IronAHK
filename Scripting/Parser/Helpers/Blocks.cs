...
namespace IronAHK.Scripting
{
	...
	{
		private Stack<CodeBlock> blocks = new Stack<CodeBlock>();
		private Stack<CodeBlock> singleLoops = new Stack<CodeBlock>();
		private Stack<CodeStatementCollection> elses = new Stack<CodeStatementCollection>();
