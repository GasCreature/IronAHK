...
namespace IronAHK.Scripting
{
	partial class Parser
	{
		...
		private CodeExpressionStatement[] ParseMultiExpression(string code)
		{
		...
		private CodeExpression ParseSingleExpression(string code)
		{
			var tokens = SplitTokens(code);
			return ParseExpression(tokens);
		}

		private CodeExpression[] ParseMultiExpression(object[] parts)
		{
