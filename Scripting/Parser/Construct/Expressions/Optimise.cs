...
namespace IronAHK.Scripting
{
	...
	{
		private bool IsOptimisableExpression(CodeExpression expr)
		{
		...
		private CodeExpression OptimiseExpression(CodeExpression expr)
		{
		...
		private CodeExpression OptimiseLoneExpression(CodeExpression expr)
		{
