...
namespace IronAHK.Scripting
{
	partial class Emit
	{
		...
		private void EmitExpressionStatement(CodeExpression expr)
		{
			stmt = true;
			EmitExpression(expr);
			stmt = false;
		...
		private void EmitExpression(CodeExpression expr)
		{
		...
		private void EmitInvoke(CodeMethodInvokeExpression invoke)
		{
		...
		private void EmitReturn(CodeMethodReturnStatement returns)
		{
		...
		private void EmitArrayIndexer(CodeArrayIndexerExpression array)
		{
		...
		private void EmitVariableDeclaration(CodeVariableDeclarationStatement var)
		{
		...
		private void EmitVariableReference(CodeVariableReferenceExpression var)
		{
			writer.Write(var.VariableName);
		}

		private void EmitArgumentReference(CodeArgumentReferenceExpression arg)
		{
			writer.Write(arg.ParameterName);
		}

		private void EmitAssignment(CodeAssignStatement assign)
		{
		...
		private void EmitArray(CodeArrayCreateExpression array)
		{
			writer.Write(Parser.ArrayOpen);
		...
		private void EmitFieldReference(CodeFieldReferenceExpression field)
		{
		...
		private void EmitComplexReference(CodePrimitiveExpression var)
		{
		...
		private void EmitComplexReference(CodeArrayCreateExpression var)
		{
		...
		private void EmitComplexReference(CodeMethodInvokeExpression var)
		{
		...
		private void EmitBinary(CodeBinaryOperatorExpression binary)
		{
			bool stmt = this.stmt;
		...
		private void EmitTernary(CodeTernaryOperatorExpression ternary)
		{
			depth++;
		...
		private void EmitPropertyReference(CodePropertyReferenceExpression property)
		{
			EmitExpression(property.TargetObject);
			writer.Write(property.PropertyName);
		}

		private void EmitPrimitive(CodePrimitiveExpression primitive)
		{
		...
		private void EmitTypeReference(CodeTypeReferenceExpression type)
		{
		...
		private bool IsInternalType(CodeTypeReferenceExpression type)
		{
