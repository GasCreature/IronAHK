...
namespace IronAHK.Scripting
{
	partial class Emit
	{
		private void EmitConditionStatement(CodeConditionStatement cond)
		{
		...
		private void EmitIteration(CodeIterationStatement iteration)
		{
		...
		private void EmitGoto(CodeGotoStatement go)
		{
		...
		private void EmitLabel(CodeLabeledStatement label)
		{
