...
namespace IronAHK.Rusty
{
	partial class Core
	{
		...
		public static int A_DefaultMouseSpeed
		{
			get
			{
				return _DefaultMouseSpeed ?? 2;
			}
			set
			{
				_DefaultMouseSpeed = value;
			}
		}
		...
		public static string A_DetectHiddenText
		{
			get
			{
				return _DetectHiddenText ?? true ? Keyword_On : Keyword_Off;
			}
			set
			{
				_DetectHiddenText = OnOff(value);
			}
		}
		...
		public static string A_DetectHiddenWindows
		{
			get
			{
				return _DetectHiddenWindows ?? false ? Keyword_On : Keyword_Off;
			}
			set
			{
				_DetectHiddenWindows = OnOff(value);
			}
		}
		...
		public static string A_FormatInteger
		{
			get
			{
				return A_FormatNumeric == "f" ? "D" : A_FormatNumeric == "x" ? "H" : string.Empty;
			}
			set
			{
		...
		public static string A_IPAddress1
		{
			get
			{
				return A_IPAddress.Length > 0 ? A_IPAddress[0] : null;
			}
		}
		...
		public static string A_IPAddress2
		{
			get
			{
				return A_IPAddress.Length > 1 ? A_IPAddress[1] : null;
			}
		}
		...
		public static string A_IPAddress3
		{
			get
			{
				return A_IPAddress.Length > 2 ? A_IPAddress[2] : null;
			}
		}
		...
		public static string A_IPAddress4
		{
			get
			{
				return A_IPAddress.Length > 3 ? A_IPAddress[3] : null;
			}
		}
		...
		public static int A_IsCritical
		{
			get
			{
				return System.Threading.Thread.CurrentThread.Priority == ThreadPriority.Highest ? 1 : 0;
			}
		}
		...
		public static int A_KeyPressDuration
		{
			get
			{
				return _KeyPressDuration ?? 0;
			}
			set
			{
				_KeyPressDuration = value;
			}
		}
		...
		public static string A_Now
		{
			get
			{
				return ToYYYYMMDDHH24MISS(DateTime.Now);
			}
		}
		...
		public static string A_NowUTC
		{
			get
			{
				return ToYYYYMMDDHH24MISS(DateTime.Now.ToUniversalTime());
			}
		}
		...
		public static string A_OSType
		{
			get
			{
				return ToOSType(Environment.OSVersion.Platform);
			}
		}
		...
		public static string A_PriorHotkey
		{
			get
			{
				return keyboardHook == null ? null : keyboardHook.PriorHotkey;
			}
		}
		...
		public static string A_StringCaseSense
		{
			get
			{
				return ToStringCaseSense(A_StringComparison);
			}
			set
			{
				switch (value.ToLowerInvariant())
				{
					...
					default:
					case Keyword_Off: _StringComparison = StringComparison.OrdinalIgnoreCase; break;
		...
		/// </summary>
		private static StringComparison A_StringComparison
		{
			get
			{
				return _StringComparison ?? StringComparison.OrdinalIgnoreCase;
			}
			set
			{
		...
		public static string A_ThisHotkey
		{
			get
			{
				return keyboardHook == null ? null : keyboardHook.CurrentHotkey;
			}
		}
		...
		public static int A_TimeSincePriorHotkey
		{
			get
			{
				return keyboardHook == null || keyboardHook.PriorHotkey == null ? -1 : Environment.TickCount - keyboardHook.PriorHotkeyTime;
			}
		}
		...
		public static int A_TimeSinceThisHotkey
		{
			get
			{
				return keyboardHook == null || keyboardHook.CurrentHotkey == null ? -1 : Environment.TickCount - keyboardHook.CurrentHotkeyTime;
			}
		}
		...
		public static string A_TitleMatchModeSpeed
		{
			get
			{
				return _TitleMatchModeSpeed ?? true ? Keyword_Fast : Keyword_Slow;
			}
			set
			{
				switch (value.ToLowerInvariant())
		...
		public static string A_YWeek
		{
			get
			{
				return DateTime.Now.ToString("yyyy") + Math.Floor((double) (DateTime.Now.DayOfYear / 12));
			}
		}
