...
namespace IronAHK.Rusty
{
	partial class Core
	{
		private class ComplexDlgOptions
		{
			...
			#endregion Public Option Properties
			...
			public void ParseComplexOptions(string Options)
			{
				...
				#endregion RegEx: Window Size, Position, and Behavior
				...
				#endregion RegEx: Layout of Objects in the Window

				#region RegEx: Font Size and Weight

				//ToDo

				#endregion RegEx: Font Size and Weight

				#region RegEx: Object Colors

				//ToDo

				#endregion RegEx: Object Colors

				#endregion Setup RegExParser for Options
				...
				#endregion Read Dict Data into Properties
			}
