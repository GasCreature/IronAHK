...
namespace IronAHK.Rusty
{
	partial class Core
	{
		private delegate void AsyncCallDlgOptions(ComplexDlgOptions options);

		private delegate void AsyncComplexDialoge(IComplexDialoge complexDlg);
