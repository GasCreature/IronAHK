...
namespace IronAHK.Rusty
{
	partial class Core
	{
		...
		private static Font ParseFont(Font standard, string styles, string family = null)
		{
		...
		private static string ToYYYYMMDDHH24MISS(DateTime time)
		{
			return time.ToString("yyyyMMddHHmmss");
		}

		private static string ToOSType(PlatformID id)
		{
			switch (id)
			{
		...
		private static string ToStringCaseSense(StringComparison type)
		{
			switch (type)
			{
		...
		private static FileAttributes ToFileAttribs(string set, FileAttributes attribs)
		{
			char state = '+';
		...
		private static string[] ToFiles(string path, bool files, bool dirs, bool recurse)
		{
		...
		private static RegistryKey ToRegRootKey(string name)
		{
		...
		private static RegistryKey ToRegKey(string RootKey, ref string SubKey, bool Parent)
		{
		...
		private static RegexOptions ToRegexOptions(string sequence)
		{
		...
		private static Regex ParseRegEx(string exp, bool reverse = false)
		{
