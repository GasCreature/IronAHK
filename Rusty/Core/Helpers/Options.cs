...
namespace IronAHK.Rusty
{
	partial class Core
	{
		private static bool? OnOff(string mode)
		{
		...
		private static bool IsAnyBlank(params string[] args)
		{
		...
		private static Dictionary<char, string> KeyValues(string Options, bool Lowercase, char[] Exceptions)
		{
		...
		private static List<string> ParseFlags(ref string arg)
		{
		...
		private static bool IsOption(string options, string search)
		{
		...
		private static bool OptionContains(string options, params string[] keys)
		{
		...
		private static bool OptionContains(string options, string key, bool casesensitive = false)
		{
		...
		private static Dictionary<string, string> ParseOptionsRegex(ref string options, Dictionary<string, Regex> items, bool remove = true)
		{
		...
		private static Dictionary<T, T2> MergeDictionarys<T, T2>(Dictionary<T, T2> dict1, Dictionary<T, T2> dict2)
		{
