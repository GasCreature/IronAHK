...
namespace IronAHK.Rusty
{
	partial class Core
	{
		private static object SafeInvoke(string name, params object[] args)
		{
		...
		private static void SafeSetProperty(object item, string name, object value)
		{
		...
		private static MethodInfo FindLocalRoutine(string name)
		{
			return FindLocalMethod(LabelMethodName(name));
		}

		private static MethodInfo FindLocalMethod(string name)
		{
		...
		private static string LabelMethodName(string raw)
		{
