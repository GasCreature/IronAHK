...
namespace IronAHK.Rusty
{
	...
	{
		private const string kernel32 = "kernel32.dll", shell32 = "shell32.dll", user32 = "user32.dll", version = "version.dll", winmm = "winmm.dll";
		...
		[DllImport(user32)]
		private static extern int SendMessage(IntPtr hwnd, uint msg, int wParam, StringBuilder sb);
