...
namespace IronAHK.Rusty.Common
{
	partial class Window
	{
		...
		public abstract class WindowManagerBase
		{
			...
			public abstract WindowItemBase LastFound
			{
				get;
				set;
			}

			public abstract IEnumerable<WindowItemBase> AllWindows
			{
				get;
			}

			public abstract WindowItemBase ActiveWindow
			{
				get;
			}
