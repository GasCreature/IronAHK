...
namespace IronAHK.Rusty.Common
{
	partial class Window
	{
		...
		public abstract class WindowItemBase
		{
			...
			public abstract IntPtr PID
			{
				get;
			}

			public abstract WindowItemBase ParentWindow
			{
				get;
			}

			public abstract WindowItemBase PreviousWindow
			{
				get;
			}
			...
			public abstract bool AlwaysOnTop
			{
				get;
				set;
			}

			public abstract bool Bottom
			{
				set;
			}
			...
			/// </summary>
			public abstract IEnumerable<WindowItemBase> ChildWindows
			{
				get;
			}
			...
			/// </summary>
			public abstract string ClassNN
			{
				get;
			}

			public abstract FormWindowState WindowState
			{
				get;
				set;
			}
