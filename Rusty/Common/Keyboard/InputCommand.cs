...
namespace IronAHK.Rusty.Common
{
	partial class Keyboard
	{
		...
		internal class IAInputCommand : Singleton<IAInputCommand>
		{
			...
			private bool _ignoreBackSpace = false;
			private bool _recognizeModifiedKeystrockes = false;
			...
			private bool _ignoreIAGeneratedInput = false;

			private List<Keys> _endkeys = new List<Keys>();

			private List<string> _endMatchings = new List<string>();
			private bool _caseSensitive = false;
			private bool _findAnywhere = false;
			...
			#endregion Singleton Config Properties
			...
			public bool RecognizeModifiedKeystrockes
			{
				get
				{
					return _recognizeModifiedKeystrockes;
				}
				set
				{
					_recognizeModifiedKeystrockes = value;
				}
			}
			...
			public bool IgnoreBackSpace
			{
				get
				{
					return _ignoreBackSpace;
				}
				set
				{
					_ignoreBackSpace = value;
				}
			}
			...
			public bool IgnoreIAGeneratedInput
			{
				get
				{
					return _ignoreIAGeneratedInput;
				}
				set
				{
					_ignoreIAGeneratedInput = value;
				}
			}
			...
			private void OnKeyPressedEvent(object sender, IAKeyEventArgs e)
			{
			...
			/// <param name="e"></param>
			/// <returns></returns>
			private bool PostAbortCondition(IAKeyEventArgs e)
			{
			...
			/// </summary>
			/// <returns></returns>
			private bool PastAbortCondition(IAKeyEventArgs e)
			{
