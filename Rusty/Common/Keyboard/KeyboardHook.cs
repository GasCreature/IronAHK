...
namespace IronAHK.Rusty.Common
{
	partial class Keyboard
	{
		...
		internal abstract class KeyboardHook
		{
			...
			private List<HotkeyDefinition> hotkeys;
			private List<HotstringDefinition> hotstrings;
			private Dictionary<Keys, bool> pressed;
			...
			private bool HasConditions(HotstringDefinition hotstring)
			{
